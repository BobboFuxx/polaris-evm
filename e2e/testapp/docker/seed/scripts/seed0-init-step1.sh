...
polard genesis add-genesis-account $KEY1 100000000000000000000000000prysm,100000000000000000000000000stgusdc --keyring-backend $KEYRING --home "$HOMEDIR"

polard genesis gentx $KEY1 1000000000000000000000prysm --keyring-backend $KEYRING --chain-id $CHAINID --home "$HOMEDIR" \
    --moniker="seed-0" \
