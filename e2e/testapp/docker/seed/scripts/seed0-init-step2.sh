...
# polard genesis add-genesis-account faucet 1000000000000000000000000000prysm,1000000000000000000000000000stgusdc --keyring-backend $KEYRING --home "$HOMEDIR"
...
# polard genesis add-genesis-account cosmos1yrene6g2zwjttemf0c65fscg8w8c55w58yh8rl 1000000000000000000000000000prysm,1000000000000000000000000000stgusdc --keyring-backend $KEYRING --home "$HOMEDIR"
